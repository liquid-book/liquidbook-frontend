...
const communities = [
  {
    label: "X",
    destination: "/community/x",
  },
  {
    label: "disscord",
    destination: "/community/disscord",
  },
  {
    label: "telegram",
    destination: "/community/telegram",
  },
];
      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://liquidbook.com/" className="flex items-center">
              {/* <img
                src="https://liquidbook.com/docs/images/logo.svg"
                className="h-8 me-3"
                alt="logBook Logo"
              /> */}
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
            © 2024{" "}
            <a href="https://liquidbook.com/" className="hover:underline">
              LiquidBook™
            </a>
            . All Rights Reserved.
          </span>
