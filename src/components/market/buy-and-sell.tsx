    ...
    return (
        <div className="flex flex-col justify-between h-[541px]">
            <div className="flex flex-col gap-2 w-full py-2">
                ...
                <div className={`${type == 'limit' ? 'flex flex-row' : 'hidden'} w-full border-2 rounded-lg px-2 py-1`}>
                ...
                <div className="flex flex-row w-full border-2 rounded-lg px-2 py-1">
                ...
                <div className="flex w-full gap-2">
                    ...
                    />
                    <div className="flex flex-row border-2 rounded-lg w-16 justify-between px-2 py-1">
            ...
            <div>
                {side == 'buy' ? (
                    <button className="w-full text-center text-base font-semibold mt-2 py-2 bg-[#2eb872] hover:opacity-80 rounded-lg">
                        Buy
                    </button>
                ) : (
                    <button className="w-full text-center text-base font-semibold mt-2 py-2 bg-[#ff5d6e] hover:opacity-80 rounded-lg">
                        Sell
                    </button>
                )}
    ...
    return (
        <div className="w-full bg-gray-900 rounded-b-lg text-white p-4">
            <Tabs defaultValue={"buy"} className="w-full">
                <TabsList className="flex w-full rounded-lg p-1 border-2 border-[#474747] bg-[#222428]">
                    <TabsTrigger 
                        value="buy"
                        className="flex-1 py-2 data-[state=active]:bg-[#2eb872] rounded-[4px] data-[state=active]:text-white text-xs font-bold p-1 text-gray-400 hover:text-gray-200 px-2"
                    >
                        Buy
                    </TabsTrigger>
                    <TabsTrigger 
                        value="sell"
                        className="flex-1 py-2 data-[state=active]:bg-[#ff5d6e] rounded-[4px] data-[state=active]:text-white text-xs font-bold p-1 text-gray-400 hover:text-gray-200 px-2"    
                    >
                        Sell
                    </TabsTrigger>
                </TabsList>
